...
技术栈体系：`Beego（Golang）` + `BootStrap` + `MySQL`
...
- https://gitee.com/TruthHun/BookStack
...
技术栈体系：`Beego（Golang）` + `FlatUI` + `MySQL`
...
- https://gitee.com/TruthHun/DocHub
...
- https://gitee.com/TruthHun/Converter

<a name="bookchat"></a>
### BookChat

项目介绍:
> 通用书籍阅读微信小程序，不仅仅是BookStack的配套小程序。
...
- https://github.com/TruthHun/BookStackWeChat
- https://gitee.com/TruthHun/BookStackWeChat
...
项目介绍:
> Api接口服务，让前端不需要再等接口，让后端不需要再被催接口，让前后端都不需要再到处找API文档
...
- https://github.com/TruthHun/ApiServ
- https://gitee.com/TruthHun/ApiServ
...
需求设计参考`知乎`、`掘金`、`Stack Overflow`、`Segment Fault`

UI和页面设计参考 `material-ui`、`element-ui`
...
技术栈体系：`Beego（Golang）` + `Vue.js` + `MySQL`
...
快5年的程序员了，非常感谢开源社区的各种开源项目给我日常开发工作带来的巨大便利。现在，我也在通过自己的努力，回馈这个社区。

同时，开源是一种兴趣，如果能有小小的赞助，也是大大的鼓励。

如果您觉得我开源的项目还行，您可以通过以下方式在您力所能及的范围内小小赞助一下，感激不尽。
...
开源项目，可能会原来越多。一般情况下，每个项目都有赞助方式和赞助二维码。

热心的网友在对A项目进行赞助的时候，可能在A项目的赞助名单里面看不到自己的赞助公示，因为他对A项目的赞助可能被写在了B项目的赞助名单下了，因为作者在收到赞助的时候，无从得知赞助是来自A项目的还是B项目的.

而且，如果每当有网友对项目进行了赞助都在项目里更新一次赞助名单的话，`watch(关注)`了开源项目的用户可能就会频繁收到不是项目源码更新而带来的邮件或短信提示。
